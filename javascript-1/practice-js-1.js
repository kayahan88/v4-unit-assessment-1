...
//CODE HERE
function iLove(nameStr, loveStr){
  return (`${nameStr} loves ${loveStr}`)
}
...
//CODE HERE
function firstItem(anArray, aCallback){
  aCallback(anArray[0])
}
...
//CODE HERE
function isItBob(anObj, callbackFn){
  if(anObj.name === 'Bob'){
    callbackFn(true)
  } else {
    callbackFn(false)
...
//CODE HERE
function giveMeDoubles(anArray, aCallback){
...
//CODE HERE
function carFactory(makeStr, modelStr, yearNum){
  let car = {
    makeStr,
    modelStr,
    yearNum
